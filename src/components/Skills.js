...
const Skill = ({name,x,y}) => {
  return (
        ...
        py-3 px-6 shadow-dark cursor-pointer absolute  dark:text-dark dark:bg-light lg:py-2 lg:px-4 md:text-sm md:py-1.5
...
const Skills= () =>{
    return(
        <>
<h2 className='font-bold text-8xl mt-64 w-full text-center ,d:text-6xl md:mt-32'>Skills</h2>
