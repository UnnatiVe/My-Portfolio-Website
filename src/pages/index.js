    ...
    <>
     ...
     <div className="flex items-center justify-between w-full lg:flex-col ">
        <div className = 'w-1/2 md:w-65'>
          <Image src={ profilePic} alt="UnnatiVerma" className='w-65 h-auto lg:hidden md:inline-block md:w-full'
          priority
     ...
     <AnimatedText text = "Transforming Ideas into Digital Solutions" className='!text-6xl !text-left
...
Explore my latest projects and articles, showcasing my expertise in React.js and web development.
     ...
     <div   className='flex items-center self-start mt-2 lg:self-center'>
      ...
      <Link href="Resume(Unnati).pdf" target={"_blank"}
      ...
      <Link href = "mailto:unnativerma20022003@gmail.com" target={"_blank"}
      ...
      <div className='absolute right-8 bottom-8 inline-block w-24 md:hidden'>
        <Image src={lightBulb} alt="UnnatiVerma" className='w-full h-auto'/>
      </div>
      </main>
    </>
  )
